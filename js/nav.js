$(document).ready(function () {
    ...
    /************** room detail(4-depth) hover. **************/
    $("#evaluation > div").on("mouseenter", function () {
    ...
    $("#evaluation").on("mouseleave", function () {
        console.log("bye");

        $("#realtime-chart").hide();
    })

//    $("#evaluation > div").on("mouseleave", function () {
//        $("#realtime-chart").hide();
//    });
